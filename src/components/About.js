...
function About({id, body}) {
  ...
  return (
    <section ref={ref} id={id} className="overflow-hidden">
      <motion.div
        className="portfolio-section introduction d-flex flex-column justify-content-between"
        ...
        <SectionHeader
          id={id}
          headline="About"
          iconClass={"fa fa-user"}></SectionHeader>
        <h5 className="display-5">
          Front-end Developer &
          <span className="highlighted-text display-5">
            {" "}
